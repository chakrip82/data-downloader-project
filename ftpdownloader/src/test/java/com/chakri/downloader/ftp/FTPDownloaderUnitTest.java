...
/**
 * The Class FTPDownloaderUnitTest.
 */
@RunWith(MockitoJUnitRunner.class)
public class FTPDownloaderUnitTest extends TestCase {
	...
	public void testGetProtocol() {
		...
		assertEquals(protocol, ftpDownloader.getProtocol());
	}
	...
	public void testDownloadData() throws DownloadManagerException {
		...
		String userName = "m01457";
		String password = "myntra@123";
		...
		try {
			...
			ftpDownloader.downloadData("ftp://localhost:21/myfile.txt", destination);
